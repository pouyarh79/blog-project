...
class Post extends Admin
{
    public function index()
    {
        ...
        $posts = $db->select('SELECT posts.*, categories.name AS category_name, users.username AS username FROM posts LEFT JOIN categories ON posts.cat_id = categories.id LEFT JOIN users ON posts.user_id = users.id ORDER BY `id` ASC');
