    ...
    <div class="col-sm-6 col-lg-3">
        <a href="<?= url('admin/user') ?>" class="text-decoration-none">
            <div class="card text-white bg-juicy-orange mb-3">
                <div class="card-header d-flex justify-content-between align-items-center"><span><i class="fas fa-users"></i> All Users</span> <span class="badge badge-pill right"><?= $adminCount["count(*)"] + $userCount["count(*)"] ?></span></div>
                <div class="card-body">
                    <section class="d-flex justify-content-between align-items-center font-12">
                        ...
                        <span class=""><i class="fas fa-user"></i> Users <span class="badge badge-pill mx-1"><?= $userCount["count(*)"] ?></span></span>
                    </section>
                </div>
            </div>
        </a>
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="<?= url('admin/comment') ?>" class="text-decoration-none">
            <div class="card text-white bg-neon-life mb-3">
                <div class="card-header d-flex justify-content-between align-items-center"><span><i class="fas fa-comments"></i> Comment</span> <span class="badge badge-pill right"><?= $commentCount["count(*)"] ?></span></div>
                <div class="card-body">
