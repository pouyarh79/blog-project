                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-left no-padding">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li> <!-- to be done by adding columns to setting in database -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
                            <ul>
                                <li><a href="<?= url('login') ?>" class="btn btn-success">ورود</a> </li><!-- to be done by adding columns to setting in database -->
                                <li> <a href="<?= url('register') ?>"class="btn btn-info">ثبت نام</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            ...
                            <li class="menu-active">
                                ...
                                <a href="<?= url($menu['url']) ?>"> <!-- appropriate urls is necessary -->
                                <?= $menu['name'] ?>
                            </a>
