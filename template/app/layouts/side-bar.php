<div class="col-lg-4">
                        <div class="sidebars-area">
                            ...
                            <div class="single-sidebar-widget ads-widget">
                                <a href="<?= $sideBarBanner['url'] ?>"><img class="img-fluid" src="<?= asset($sideBarBanner['image']) ?>" alt=""></a>
                            </div>
                            <?php }?>
                            <div class="single-sidebar-widget most-popular-widget">
                                ...
                                <div class="single-list flex-row d-flex">
                                    <div class="thumb">
                                        <img src="<?= asset($mostCommentedPost['image']) ?>" alt="" width="110" height="70">
                                    </div>
                                    <div class="details">
                                        ...
                                        <ul class="meta">
                                            ...
                                            <li><a href="#"><?= $mostCommentedPost['comments_count'] ?><span class="lnr lnr-bubble"></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <?php }?>
