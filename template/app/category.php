        ...
        <section class="latest-post-area pb-120">
            <div class="container no-padding">
                <div class="row">
                            ...
                            <div class="row mt-20 medium-gutters">
                                ...
                                <div class="col-lg-6 single-popular-post">
                                    ...
                                    <div class="details">
                                        ...
                                        <ul class="meta">
                                            <li><a href="#"><span class="lnr lnr-user"></span><?= $popularPosts[1]['category']?></a></li>
                                ...
                                <div class="col-lg-6 single-popular-post">
                                    ...
                                    <div class="details">
                                        ...
                                        <ul class="meta">
                                            <li><a href="#"><span class="lnr lnr-user"></span><?= $popularPosts[2]['category']?></a></li>
                    ...
                    require_once(BASE_PATH . '/template/app/layouts/side-bar.php');
